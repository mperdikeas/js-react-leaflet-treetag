...
export default function getFeatureData(id, cancelToken) {
    return (dispatch, getState) => {
      ...
      console.log('no previous pending request found to cancel');
      console.log(cancelToken);
        dispatch (markGetFeatureInfoInProgress());
                         ...
                         if (err.message === OP_NO_LONGER_RELEVANT) {
                           ...
                           switch(code) {
                             case 'JWT-verif-failed': {
                               dispatch( markGetFeatureInfoFailed() );
                               dispatch( displayModalLogin( ()=>{dispatch(fetchData(id, cancelToken))}));
