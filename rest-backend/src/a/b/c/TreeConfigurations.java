...
public class TreeConfigurations {
    ...
    public LinkedHashMap<Integer, TreeConfiguration> value;


    public TreeConfigurations(final LinkedHashMap<Integer, TreeConfiguration> value) {
        this.value = value;
    }


    public static TreeConfigurations example() {
        ...
        return new TreeConfigurations(rv);
    }
